...
namespace PChecker.Actors
{
    ...
    public interface IActorRuntime : ICoyoteRuntime
    {
        ...
        void SendEvent(ActorId targetId, Event e, int loc, Guid opGroupId = default, SendOptions options = null);
        ...
        Task<bool> SendEventAndExecuteAsync(ActorId targetId, Event e, int loc, Guid opGroupId = default, SendOptions options = null);
